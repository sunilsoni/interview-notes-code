...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        MoveResult r2 = game1.play(0, 0, Action.MINE_ABSENT);
        ...
        game2.putMineForTest(4, 4);

        MoveResult r3 = game2.play(0, 0, Action.MINE_ABSENT);
        test("Blank cell should expand",
                r3.correct() && r3.changedCells().size() > 1);

        MinesweeperGame game3 = new MinesweeperGame(5, 5, 0);
        game3.clearBoardForTest();
        game3.putMineForTest(2, 2);

        MoveResult r4 = game3.play(2, 2, Action.MINE_ABSENT);
        ...
        MoveResult r5 = game4.play(0, 0, Action.MINE_PRESENT);
        test("Mine present but no mine there",
                !r5.correct() && r5.changedCells().isEmpty());

        MoveResult r6 = game4.play(-1, 20, Action.MINE_ABSENT);
