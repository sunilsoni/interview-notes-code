...
public class AmazonErrorString {
    ...
    public static int getMinErrors(String s, int x, int y) {
        ...
        for (char ch : s.toCharArray()) {
            if (ch == '!') {
                ...
                if (left == '0') zerosSeen++; else onesSeen++;
            } else {
                if (ch == '0') zerosSeen++; else onesSeen++;
            }
    ...
    public static void main(String[] args) {
        ...
        class TC {
            final String s; final int x, y; final Long exp;
            TC(String s, int x, int y, Long exp) { this.s = s; this.x = x; this.y = y; this.exp = exp; }
        }
