...
public class Main {
    ...
    public static class Post {
        private int id;
        public Post() {}                    // Gson needs no-arg constructor
    ...
    private static void runTests() {
        ...
        if (r1.equals(e1)) { System.out.println("Test1: PASS"); passed++; }
        else              { System.out.println("Test1: FAIL → " + r1); }
        ...
        if (r2.equals(e2)) { System.out.println("Test2: PASS"); passed++; }
        else              { System.out.println("Test2: FAIL → " + r2); }
        ...
        if (r3.equals(e3)) { System.out.println("Test3: PASS"); passed++; }
        else              { System.out.println("Test3: FAIL → " + r3); }
        ...
        long sum = LR.stream()
            ...
            .sum();
        if (sum == M) { System.out.println("Test4: PASS"); passed++; }
        else          { System.out.println("Test4: FAIL → counted " + sum); }
