...
public class ParticipantScores {
    ...
    public static int getPoints(char difficulty) {
        ...
        switch (difficulty) {
            case 'E': return 2;  // Easy problem gives 2 points
            case 'M': return 5;  // Medium problem gives 5 points
            case 'H': return 7;  // Hard problem gives 7 points
            default: return 0;  // Invalid character gives 0 points
        }
    }
