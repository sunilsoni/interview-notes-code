...
class PersonalLoanDept extends LoanDepartment {
    PersonalLoanDept(int clients) { loanAmounts = new int[clients]; }
    protected String entityName() { return "clients"; }
    protected String entityNamePlural() { return "clients"; }
}

class BusinessLoanDept extends LoanDepartment {
    BusinessLoanDept(int businesses) { loanAmounts = new int[businesses]; }
    protected String entityName() { return "businesses"; }
    protected String entityNamePlural() { return "businesses"; }
}
...
public class LoanProcessingSystem {
    ...
    static void runTest(int[] counts, int[] clientLoans, int[] businessLoans, List<String> expected, String testName) {
        ...
        if (!pass) { System.out.println("Expected: " + expected); System.out.println("Got: " + output); }
    }
}