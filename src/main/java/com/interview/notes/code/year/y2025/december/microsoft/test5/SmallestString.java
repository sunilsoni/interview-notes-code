...
public class SmallestString {
    ...
    public static void main(String[] args) {
        ...
        // Provided test cases
        total++; if (test("Sample 0", "baacba", "aabbca")) pass++;
        total++; if (test("Sample 1", "ababbaab", "aaaabbbb")) pass++;
        total++; if (test("Example", "abaacbac", "aaabbcac")) pass++;
        
        // Edge cases
        total++; if (test("Single a", "a", "a")) pass++;
        total++; if (test("Single b", "b", "b")) pass++;
        total++; if (test("Single c", "c", "c")) pass++;
        total++; if (test("All a", "aaaa", "aaaa")) pass++;
        total++; if (test("All b", "bbbb", "bbbb")) pass++;
        total++; if (test("All c", "cccc", "cccc")) pass++;
        total++; if (test("Only ab", "baba", "aabb")) pass++;
        total++; if (test("Only bc", "cbcb", "bbcc")) pass++;
        total++; if (test("Only ac", "caca", "caca")) pass++;
        total++; if (test("c blocks", "cab", "bca")) pass++;
        total++; if (test("c first", "cba", "bca")) pass++;
        total++; if (test("Sorted", "aabbcc", "aabbcc")) pass++;
        total++; if (test("Two chars", "ba", "ab")) pass++;
        ...
        total++; if (test("100K alt ab", in1.toString(), out1.toString())) pass++;
        ...
        total++; if (test("100K c blocks", in2.toString(), out2.toString())) pass++;
