...
public class Solution {
    ...
    public static void main(String[] args) {
        class Test { String t, p, s, desc; String exp; }
        List<Test> tests = Arrays.asList(
                new Test() {{ t="nothing";     p="bruno";     s="ingenious"; exp="nothing"; desc="Sample0"; }},
                new Test() {{ t="ab";          p="b";         s="a";         exp="a";       desc="Sample1"; }},
                new Test() {{ t="engine";      p="raven";     s="ginkgo";    exp="engin";   desc="Example"; }},
                new Test() {{ t="banana";      p="bana";      s="nana";      exp="banana";  desc="Overlap"; }},
                new Test() {{ t="abracadabra"; p="habrahabr"; s="bracket";   exp="abrac";   desc="Custom"; }}
        );
        for (Test tc : tests) {
