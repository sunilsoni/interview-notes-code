package com.interview.notes.code.year.y2025.June.apple.test5;
...
You are given a binary tree and two nodes within it. Your task is to find their **Lowest Common Ancestor (LCA)**.

* You can **only use child-of relationships** (i.e., navigate from a parent node to its children).
...
class Test {
    public static void main(String[] args) {
        ...
        TreeNode result4 = solution.lowestCommonAncestor(root3, root3.left, root3.left.left);
        System.out.println("Test 4: " + (result4.val == 2 ? "PASS" : "FAIL"));
    }
}
