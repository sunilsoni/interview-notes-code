...
import java.util.LinkedHashMap; // import LinkedHashMap for ordered entries
import java.util.List; // import List interface for policy collection
import java.util.ArrayList; // import ArrayList to hold policies
import java.util.Map; // import Map interface for filtering entries
