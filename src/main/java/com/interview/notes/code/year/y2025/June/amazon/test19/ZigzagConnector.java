...
public class ZigzagConnector {
    ...
    public static void main(String[] args) {
        ...
        if (testEmpty()) {
            ...
            System.out.println("testEmpty: FAIL");
        }
        if (testSingleNode()) {
            System.out.println("testSingleNode: PASS");
            passed++;
        } else {
            System.out.println("testSingleNode: FAIL");
        }
        if (testTwoLevels()) {
            System.out.println("testTwoLevels: PASS");
            passed++;
        } else {
            System.out.println("testTwoLevels: FAIL");
        }
        if (testExample()) {
            System.out.println("testExample: PASS");
            passed++;
        } else {
            System.out.println("testExample: FAIL");
        }
        if (testLarge()) {
            System.out.println("testLarge: PASS");
            passed++;
        } else {
            System.out.println("testLarge: FAIL");
        }
