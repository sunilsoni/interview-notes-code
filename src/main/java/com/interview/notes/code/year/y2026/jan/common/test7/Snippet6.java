...
public class Snippet6 {
    ...
    public static void main(String[] args)
        ...
        TargetHolder<String> targetA =
                instance.createTarget(String.class);

        TargetHolder<Object> targetB =
                instance.createTarget(Object.class);
    ...
    private <T> TargetHolder<T> createTarget(Class<T> clazz)
        ...
        TargetHolder<T> target = new TargetHolderImpl<T>();
