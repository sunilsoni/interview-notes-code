...
class Chinese extends Cuisine {
    ...
    @Override
    public Cuisine serveFood(String dish) { return new Chinese(dish); }
}
...
class Italian extends Cuisine {
    ...
    public String getDish() { return dish; }
    @Override
    public Cuisine serveFood(String dish) { return new Italian(dish); }
}
...
class Japanese extends Cuisine {
    ...
    public String getDish() { return dish; }
    @Override
    public Cuisine serveFood(String dish) { return new Japanese(dish); }
}
...
class Mexican extends Cuisine {
    ...
    public String getDish() { return dish; }
    @Override
    public Cuisine serveFood(String dish) { return new Mexican(dish); }
}
    ...
    public static void main(String[] args) {
        ...
        while (totalNumberOfOrders-- > 0) {
            ...
            try {
                ...
                switch (cuisine) {
                    case "Chinese":
                        results.add("Serving " + ((Chinese) servedFood).getDish() + "(Chinese)");
                        break;
                    case "Italian":
                        results.add("Serving " + ((Italian) servedFood).getDish() + "(Italian)");
                        break;
                    case "Japanese":
                        results.add("Serving " + ((Japanese) servedFood).getDish() + "(Japanese)");
                        break;
                    case "Mexican":
                        results.add("Serving " + ((Mexican) servedFood).getDish() + "(Mexican)");
                        break;
                }
