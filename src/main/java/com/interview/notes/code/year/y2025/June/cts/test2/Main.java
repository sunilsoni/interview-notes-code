...
public class Main {
    public static void main(String[] args) {
        ...
        // Sample0
        {
            ...
            total++;
            if (lib.calculateTotal() == 21091) pass("Sample0 calculateTotal");
            else fail("Sample0 calculateTotal", 21091, lib.calculateTotal());
        ...
        // Sample1
        {
            ...
            addSample1(lib);
            total++;
            if (lib.calculateTotal() == 20726) pass("Sample1 calculateTotal");
            else fail("Sample1 calculateTotal", 20726, lib.calculateTotal());
        }
