package com.interview.notes.code.months.year2023.july23.test11;

class Solution2 {
    public static void main(String[] args) {
        Solution2 solution = new Solution2();
        System.out.println(solution.solution("39878")); // 898  898
        System.out.println(solution.solution("00900")); // 9 00900
        System.out.println(solution.solution("0000")); // 0 0000
