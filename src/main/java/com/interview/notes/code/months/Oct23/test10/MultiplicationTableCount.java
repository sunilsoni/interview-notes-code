...
/**
 * Please explain the questions and requirements, and provide a step-by-step plan for solving them. use easy to understand naming conventions while writing code
 *
 * Additionally, include code with explanations, and calculate time and space complexity at each step by step.
 *
 *
 *
 *
