...
public class NthRepeatingElement {
    public static int findNthRepeatingElement(int[] arr, int n) {
        ...
        int[] repeatingElements = new int[arr.length]; // Increase the size of repeatingElements array
        int nextIndex = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Second repeating element in {1, 2, 3, 4, 3, 1, 2, 5, 5, 6, 6}: " + secondRepeatingElement1); // Output: 1
        ...
        System.out.println("Fourth repeating element in {1, 1, 2, 3, 4, 2, 5, 5, 6, 6, 7, 7}: " + fourthRepeatingElement3); // Output: 6
    }
}
